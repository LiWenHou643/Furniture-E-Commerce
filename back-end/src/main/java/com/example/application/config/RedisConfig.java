...
public class RedisConfig {
	...
	@Bean
	LettucePoolingClientConfiguration lettucePoolConfig(ClientResources clientResources, ClientOptions clientOptions) {
		GenericObjectPoolConfig<Object> genericObjectPoolConfig = new GenericObjectPoolConfig<>();
		genericObjectPoolConfig.setMaxTotal(maxTotal);
		genericObjectPoolConfig.setMaxIdle(maxIdle);
		return LettucePoolingClientConfiguration.builder().poolConfig(genericObjectPoolConfig)
				.clientResources(clientResources).clientOptions(clientOptions).build();
	}
}